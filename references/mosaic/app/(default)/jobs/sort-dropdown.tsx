...
export default function SortDropdown({
  ...
  return (
    <Menu as="div" className="relative inline-flex">
      ...
      <Transition
        as="div"
        className={`origin-top-right z-10 absolute top-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${align === 'right' ? 'right-0' : 'left-0'
          }`}
